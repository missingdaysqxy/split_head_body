...
def FaceModel(num_output=21, input_shape=(500, 500, 3)):
    ...
    def _crop(target_layer, offset=(None, None), name=None):
        ...
        def f(x):
            ...
            cropped = Cropping2D(cropping=(
            (offset[0], width - offset[0] - target_width), (offset[1], height - offset[1] - target_height)),
                                 name='{}'.format(name))(x)
            return cropped
